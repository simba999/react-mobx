...
class GrowthLevers3 extends Component {
	constructor(props) {
		super(props);
  ...
  componentDidMount() {
    ...
    setTimeout( loadData, 50);
    reactLocalStorage.set('lastPage', '/wave/session/growth-levers/3');
  };
							...
							<div className='col-sm-12'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>3. Profitable Growth</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Talk about how you could grow your product profitably; estimate the lifetime value of one user.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>How much profit would one customer be worth over the course of your potential future relationship with them? How many times might they spend with you in one year, for how many years?</li>
								<li>How could you grow your revenue from existing customers?</li>
								<li>Which growth levers would require money or time?</li>
							</ul>
...
export default observer(GrowthLevers3)
