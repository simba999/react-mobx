...
class GrowthLevers2 extends Component {
	constructor(props) {
		super(props);
							...
							<div className='col-sm-12'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>2. Customer Growth</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about how you could grow your product's customer or user base.
												<br /><br />
												How would you add new users at each point of the funnel? Which point of the funnel is most important?
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>Which channels could you use to find new users?</li>
								<li>Could you encourage existing users to bring in other customers through sharing or referrals?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Discuss owned, earned, and paid growth levers, including key terms like PR, SEO/SEM, paid social, content marketing, and email marketing.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(GrowthLevers2)
