...
class BackEndDev2 extends Component {
	constructor(props) {
		super(props);
							...
							<div className='col-sm-12'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>2. Core Technologies</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Discuss the core back-end technologies that would be necessary to make your product work and think about optimal programming languages.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>What methods and technologies would you use to store and retrieve data efficiently? This could include data collected from the user and pre-existing data that your program requires to run.</li>
								<li>Which back-end programming languages would be most suitable for your product and why?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Talk about the main elements of back-end; discuss key terminology including logic, servers and databases. Also, discuss common back-end programming languages like Python, Go and Ruby, and share about the purpose, pros and cons of each.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(BackEndDev2)
