...
class MediaContent1 extends Component {
	constructor(props) {
		super(props);
						...
						<div className='row'>
							<div className='col-sm-12'>
								...
								<div className='guide-card-nav-container'>
									<Link to='/wave/session/media-content'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Discuss your product's target audience and outline a new brand voice that would attract users and help them love your product.
											</div>
										</div>
						...
						<div className='container'>
							...
							<h4>Conversation Starters</h4>
								<div>
									...
									<ul>
										<li>What other content does your audience consume?</li>
										<li>How would your voice be similar/different?</li>
									</ul>
									...
									{userType === 'professional' &&
										<div>
											...
											<div className='guide-protip'>
												...
												<p className='guide-protip-body'>Use your favorite company as an example: how would you define that company's brand voice?</p>
											</div>
										</div>
									}
								</div>
...
export default observer(MediaContent1)
