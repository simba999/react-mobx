...
class FrontEndDev3 extends Component {
	constructor(props) {
		super(props);
  ...
  componentDidMount() {
    ...
    setTimeout( loadData, 50);
    reactLocalStorage.set('lastPage', '/wave/session/front-end-dev/3');
  };
						...
						<div className='row'>
							<div className='col-sm-12'>
								...
								<div className='guide-card-nav-container'>
									<Link to='/wave/session/front-end-dev/2'>
										<div className='guide-card-nav-button pull-left'>
											<span className='glyphicon glyphicon-chevron-left'></span>
										</div>
									</Link>

									<Link to='/wave/session/front-end-dev/4'>
									...
									<div className='guide-card-nav-center'>
										<ul className="nav-dots">
											<Link to='/wave/session/front-end-dev/1'>
												<li className="nav-dot"></li>
											</Link>
											<Link to='/wave/session/front-end-dev/2'>
												<li className="nav-dot"></li>
											</Link>
											<Link to='/wave/session/front-end-dev/3'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>3. Front-End Optimization</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Determine the front-end programming languages you'd use based on the product features you think are most important.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>Are there front-end frameworks that would streamline development, such as JavaScript or CSS libraries that could be used to speed up the execution process?</li>
								<li>How could you collect feedback from users to improve your product?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Share specific tools you use to track performance and make improvements.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(FrontEndDev3)
