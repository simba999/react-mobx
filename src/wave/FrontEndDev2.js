...
class FrontEndDev2 extends Component {
	constructor(props) {
		super(props);
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>What aspects of your product are absolutely essential for a positive customer experience?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Share your favorite online resources for looking up code and troubleshooting.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(FrontEndDev2)
