							...
							<div className='col-sm-12'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											...
											<h3>1. MVP Product Requirements</h3>
											<div className='divider-honey mt-20'></div>
										</div>
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about the minimum viable product, or MVP, requirements of your product; in other words, what features are "must-haves" for the product to go live. Talk about what browsers, devices, and operating systems would need to be able to support the product in order to launch. 
											</div>
										</div>
						...
						<div className='container'>
							...
							<h4>Conversation Starters</h4>
								<div>
									...
									<ul>
										<li>What are the ways a user could interact with your product?</li>
										<li>Beyond what the user sees, what back-end systems might you want to test?</li>
										<li>What types of errors could occur? What are the worst errors that could occur?</li>
									</ul>
									...
									{userType === 'professional' &&
										<div>
											...
											<div className='guide-protip'>
												...
												<p className='guide-protip-body'>Tell your Advisee how you identify all potential errors and how you determine which errors are most harmful to a user's consumer experience.</p>
											</div>
										</div>
									}
								</div>
