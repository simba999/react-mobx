...
class MediaContent3 extends Component {
	constructor(props) {
		super(props);
  ...
  componentDidMount() {
    ...
    setTimeout( loadData, 50);
    reactLocalStorage.set('lastPage', '/wave/session/media-content/3');
  };
							...
							<div className='col-sm-12'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>3. Content Delivery</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Talk through how you'd get your content to the right audience: social media, paid promotion, native advertising, etc.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>Where is your audience already spending time looking for content?</li>
								<li>Could you promote your content in these places? If so, how would you make it stand out?</li>
								<li>Would you need to pay to promote your content?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Ask your Advisee to name a brand whose content she reads regularly. What are the different ways she finds that content?</p>
									</div>
								</div>
							}
						</div>
...
export default observer(MediaContent3)
