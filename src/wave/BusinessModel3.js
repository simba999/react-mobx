...
class BusinessModel3 extends Component {
	constructor(props) {
		super(props);
  ...
  componentDidMount() {
    ...
    setTimeout( loadData, 50);
    reactLocalStorage.set('lastPage', '/wave/session/business-model/3');
  };
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Talk about how much profit your product would earn (profit = revenue - costs) in the early stages.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>How much money would you make per unit sold of your product (price per unit - cost per unit)?</li>
								<li>How many units would you need to sell to break even? To make a profit?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Brainstorm some out-of-the-box ways you could cut costs. Could you get any materials for free? Could you get customers to do some of your work for you?</p>
									</div>
								</div>
							}
						</div>
...
export default observer(BusinessModel3)
