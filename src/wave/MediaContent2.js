...
class MediaContent2 extends Component {
	constructor(props) {
		super(props);
						...
						<div className='row'>
							<div className='col-sm-12'>
								...
								<div className='guide-card-nav-container'>
									<Link to='/wave/session/media-content/1'>
										<div className='guide-card-nav-button pull-left'>
											<span className='glyphicon glyphicon-chevron-left'></span>
										</div>
									</Link>

									<Link to='/wave/session/media-content/3'>
									...
									<div className='guide-card-nav-center'>
										<ul className="nav-dots">
											...
											<Link to='/wave/session/media-content/2'>
												<li className="nav-dot-active"></li>
											</Link>
											<Link to='/wave/session/media-content/3'>
												<li className="nav-dot"></li>
											</Link>
											<Link to='/wave/session/media-content/4'>
												<li className="nav-dot"></li>
											</Link>
										</ul>
									</div>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>2. Content Type</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about what types of content you'd create to support your product and what platforms you'd use to share the product's key messages.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>What type of content would be most engaging for your audience - blog posts, photos, videos.? </li>
								<li>Who would create that content?</li>
								<li>Would you hire people, partner with content creators, have your community contribute.?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Share a sample content plan showing what types of content gets posted and the topic of each post.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(MediaContent2)
