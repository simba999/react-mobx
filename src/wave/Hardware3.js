...
class Hardware3 extends Component {
	constructor(props) {
		super(props);
  ...
  componentDidMount() {
    ...
    setTimeout( loadData, 50);
    reactLocalStorage.set('lastPage', '/wave/session/hardware/3');
  };
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about what would be needed to begin manufacturing your product and bring it to the mass market.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>Would your product have one standard prototype that would be easy for a manufacturer to recreate?</li>
								<li>What factors (price, timeline, etc.) would you want to consider when looking for a manufacturer?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Describe what manufacturers do and what you would look for in a manufacturer. Share tips to follow or any pitfalls to avoid.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(Hardware3)
