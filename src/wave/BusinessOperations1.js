...
class BusinessOperations1 extends Component {
	constructor(props) {
		super(props);
						...
						<div className='row'>
							<div className='col-sm-12'>
								...
								<div className='guide-card-nav-container'>
									<Link to='/wave/session/business-operations'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about the design, build, marketing, and distribution of your product. Talk about the tasks you'd need to complete and the processes you could put in place to ensure everything would run smoothly (without bottlenecks or breakdowns).
											</div>
										</div>
						...
						<div className='container'>
							...
							<h4>Conversation Starters</h4>
								<div>
									...
									<ul>
										<li>What would be the most important outcome for your user?</li>
										<li>Which tasks would absolutely have to be completed to enable that outcome?</li>
										<li>What processes would help make sure those tasks are fulfilled?</li>
										<li>What might be potential slow-downs, or bottlenecks, in these processes?</li>
									</ul>
									...
									{userType === 'professional' &&
										<div>
											...
											<div className='guide-protip'>
												...
												<p className='guide-protip-body'>Show a process plan you've put together or describe a work plan you've used that allocates responsibility across teams.</p>
											</div>
										</div>
									}
								</div>
...
export default observer(BusinessOperations1)
