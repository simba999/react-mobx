...
class StorytellingBrand2 extends Component {
	constructor(props) {
		super(props);
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about your brand identity; what are your core values, what would your mission statement say? 
												<br /><br />
												Brainstorm how you could visually represent these values.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>Brainstorm a potential mission statement or tag line</li>
								<li>What words would accurately describe your brand?</li>
								<li>What color, images, and logo would you use in your branding?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Spend a few minutes looking at brand mission statements from companies you love.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(StorytellingBrand2)
