...
class BusinessOperations3 extends Component {
	constructor(props) {
		super(props);
  ...
  componentDidMount() {
    ...
    setTimeout( loadData, 50);
    reactLocalStorage.set('lastPage', '/wave/session/business-operations/3');
  };
							...
							<div className='col-sm-12'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											<h3>3. Anticipate Problems</h3>
											<div className='divider-honey mt-20'></div>
										</div>

										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Think about how you'd measure success and what could get in the way of your product goals. Discuss ways to prevent these blockers.
											</div>
										</div>
				...
				<section className={(this.state.morecontentdiv) ? 'guide-footer-container-is-open' : 'guide-footer-container'}>
					...
					<div className='guide-footer-body'>
						<div className='container'>
							...
							<ul>
								<li>Which metrics could you track to measure success for your product?</li>
								<li>What barriers might get in the way of the product's success?</li>
								<li>What processes could prevent these barriers from being blockers to success?</li>
							</ul>
							...
							{userType === 'professional' &&
								<div>
									...
									<div className='guide-protip'>
										...
										<p className='guide-protip-body'>Go through an example metrics dashboard. Talk about how often you look at the dashboard to track success.</p>
									</div>
								</div>
							}
						</div>
...
export default observer(BusinessOperations3)
