...
class FrontEndDev1 extends Component {
	constructor(props) {
		super(props);
						...
						<div className='row'>
							<div className='col-sm-12'>
								...
								<div className='guide-card-nav-container'>
									<Link to='/wave/session/front-end-dev'>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											...
											<h3>1. Front-End Basics</h3>
											<div className='divider-honey mt-20'></div>
										</div>
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Discuss the functionality your product would need and what you could build with front-end.
											</div>
										</div>
						...
						<div className='container'>
							...
							<h4>Conversation Starters</h4>
								<div>
									...
									<ul>
										<li>What's the main purpose of your product-sell something, capture emails, display content, etc?</li>
										<li>Would the product involve user input?</li>
										<li>Which pieces of the product functionality would be built with front-end?</li>
									</ul>
									...
									{userType === 'professional' &&
										<div>
											...
											<div className='guide-protip'>
												...
												<p className='guide-protip-body'>Live code examples of the front-end functionalities you discuss with your Advisee!</p>
											</div>
										</div>
									}
								</div>
...
export default observer(FrontEndDev1)
