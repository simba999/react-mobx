...
class GrowthLevers1 extends Component {
	constructor(props) {
		super(props);
						...
						<div className='row'>
							<div className='col-sm-12'>
								...
								<div className='guide-card-nav-container'>
									<Link to='/wave/session/growth-levers'>
										<div className='guide-card-nav-button pull-left'>
											<span className='glyphicon glyphicon-chevron-left'></span>
										</div>
									</Link>

									<Link to='/wave/session/growth-levers/2'>
									...
									<div className='guide-card-nav-center'>
										<ul className="nav-dots">
											<Link to='/wave/session/growth-levers/1'>
												<li className="nav-dot-active"></li>
											</Link>
											<Link to='/wave/session/growth-levers/2'>
												<li className="nav-dot"></li>
											</Link>
											<Link to='/wave/session/growth-levers/3'>
												<li className="nav-dot"></li>
											</Link>
											<Link to='/wave/session/growth-levers/4'>
												<li className="nav-dot"></li>
											</Link>
										</ul>
									</div>
								...
								<div className='guide-card-container'>
										...
										<div className='guide-card-hero'>
											...
											<h3>1. Path to Action</h3>
											<div className='divider-honey mt-20'></div>
										</div>
										<div className='guide-card-body'>
											<div className='guide-card-body-text'>
												Discuss who might be early adopters of your product and why.
												<br /><br />
												Talk about how customers would move through the "funnel" of your product - how they would go from awareness to interest, then conversion - aka taking the action you want (making a purchase, sharing an email address, clicking on a link, completing a task).
											</div>
										</div>
						...
						<div className='container'>
							...
							<h4>Conversation Starters</h4>
								<div>
									...
									<ul>
										<li>What's the core use case of your product?</li>
										<li>Who would have the most frequent and urgent need for this use case?</li>
										<li>How would you convert users from interest to action?</li>
									</ul>
									...
									{userType === 'professional' &&
										<div>
											...
											<div className='guide-protip'>
												...
												<p className='guide-protip-body'>Talk through how you'd message your users at each touch-point (ad, email, text, notification, etc.), and what you would say.</p>
											</div>
										</div>
									}
								</div>
...
export default observer(GrowthLevers1)
