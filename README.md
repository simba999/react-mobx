# BUILTBYGIRLS [![Build Status](https://travis-ci.org/facebookincubator/create-react-app.svg?branch=master)](https://travis-ci.org/facebookincubator/create-react-app)

## What’s Inside?

The BUILTBYGIRLS app leverages some of the most scalable and battle-tested technologies used by Google, Facebook, Netflix, LinkedIn, Yahoo!, Microsoft, Walmart, AirBnB and other top tech companies. Software, hardware, and other tools include:

### Software
* [Javascript](https://www.javascript.com) - Language
* [Node.js](https://nodejs.org) - Environment
* [React](https://https://facebook.github.io/react) - Front-End Library

### Hardware/Services
* [Heroku](https://www.heroku.com) - Server
* [Firebase](https://firebase.google.com) - Database, File Storage & Authentication
* [Github](https://github.com) - Version Control & Code Repository
* [Intercom](https://www.intercom.com) - CRM & Email Delivery
...
All of the aforementioned libraries and tools are transitive dependencies of the included npm package.
...
BUILTBYGIRLS works on MacOS, Windows, and Linux.  

## tl;dr

```sh
git clone https://github.com/roblafave/builtbygirls.git
...
Then open [http://localhost:3000/](http://localhost:3000/) to see app.<br>
...
**Strongly recommend using Node >= 6 and npm >= 3 for faster installation speed and better disk usage.** You can use [nvm](https://github.com/creationix/nvm#usage) to easily switch Node versions between different projects.
...
### `npm start`, `yarn start` or `yarn run dev`
...
Deploys the production build to the Heroku app server.

### `firebase deploy --only functions`

Deploys the production Google Cloud Functions to Firebase.
